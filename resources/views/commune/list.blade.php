...
<section class="content">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    ...
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="{{ route('commune') }}"> <i class="fa fa-plus"></i>  Ajouter Commune</a>  
                                    </div>
                                </div>
       ...
       <td>
        ...
        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModa5" data-name="{{ $commune->name }}" data-code="{{ $commune->code }}"  data-wilaya_id="{{ $commune->wilaya_id }}" data-id="{{ $commune->id }}" ><i class="fa fa-pencil" aria-hidden="true"></i></button>
        
        
        
        <a class="btn btn-danger btn-sm"  title="Delete" href="{{ url('commune/delete/'.$commune->id) }}"  data-toggle="tooltip" data-placement="right" onclick="return confirm('are you sure to delete');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
        @else
        @endif
    </td>
    </tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="{{ url('commune/update') }}" method="POST" class="col-sm-12">
                              @csrf
