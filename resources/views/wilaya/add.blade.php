...
<section class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <h1>Wilaya</h1>
                            <small>Ajouter wilaya</small>
                            <ol class="breadcrumb hidden-xs">
                                <li><a href="index.html"><i class="pe-7s-home"></i> wilaya</a></li>
                                <li class="active">Ajouter wilaya</li>
                            </ol>
                        </div>
                    </section>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-primary" href="{{ route('wilayalist') }}"> <i class="fa fa-list"></i>  liste des wilayas </a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <form  class="col-sm-12" action="{{ route('storewil') }}" method="POST" >
                                          @csrf
