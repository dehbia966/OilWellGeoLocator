...
<section class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <h1>Bassin</h1>
                            <small>Ajouter Bassin</small>
                            <ol class="breadcrumb hidden-xs">
                                <li><a href="index.html"><i class="pe-7s-home"></i> Bassin</a></li>
                                <li class="active">Ajouter Bassin</li>
                            </ol>
                        </div>
                    </section>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-primary" href="{{ route('bassinlist') }}"> <i class="fa fa-list"></i>  liste des bassins </a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <form  class="col-sm-12" action="{{ route('storebas') }}" method="POST" >
                                          @csrf
